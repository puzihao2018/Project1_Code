...
Inc_Done:
	...
	mov a, Count10ms
	cjne a, #100, Timer1_ISR_Time_Not_Reached ; Warning: this instruction changes the carry flag!
...
MainLoop:
    lcall Timer1_Init
    ;the following process will be done on Timer1_ISR
    sjmp MainLoop
