; This example shows how to use DAC0 to output a voltage ramp
; from pin P2.0.  The CCU (similar to timer 2) is used to generate
...
CCU_ISR:
	...
	inc AD0DAT3 ; Output a ramp to the DAC0 (P2.0)
...
InitDAC0:
    ; Configure pin P2.0 (DAC0 output pin) as open drain
	orl	P2M1,   #(1<<0)
	orl	P2M2,   #(1<<0)
    mov ADMODB, #00100100B ; Select main clock/2 for ADC/DAC.  Also enable DAC1 output (Table 25 of reference manual)
	mov	ADCON0, #00000100B ; Enable the converter
	ret
...
MainProgram:
	...
	lcall InitDAC0 ; Call after 'Ports_Init
	lcall CCU_Init
