...
InitialMessage: db '\r\nP89LPC9351 ADC1 test program.  Input pins are P0.1, P0.2, P0.3, and P0.4.\r\n', 0
...
MainProgram:
    ...
    ; Select main clock/2 for ADC/DAC.  Also enable DAC1 output (Table 25 of reference manual)
    orl ADMODB, #00101000B
