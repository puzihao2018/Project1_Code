...
CCU_ISR:
	...
	mov a, #0xff
	dec w+0
	cjne a, w+0, keep_playing ;ff is negative one
	dec w+1
...
; loop.                           ;
;---------------------------------;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;every thing above this is the interface with computer
MainProgram:
    mov SP, #0x7F
...
forever_loop: ;if pressed reset everyting
	jb RI, serial_get ;if RI is set then receive message from computer
